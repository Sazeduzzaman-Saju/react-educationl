...
const Footer = () => {
    return (
        <div>
            <section className="py-6 structure bg-white-800 text-black-50 mb-5 ">
                <div className=" call-to-action container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                    ...
                    <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                        <button className="blog-button inline-flex items-center px-6 py-3 rounded-lg dark:bg-violet-400 dark:text-gray-900">
                        ...
                        <button className=" blog-button inline-flex items-center px-5 py-3 rounded-lg dark:bg-violet-400 dark:text-gray-900">
                            ...
                            <span className="flex flex-col items-start ml-4 leading-none">
                                <span className="mb-1 text-xs blog-btn ">Download on the</span>
            ...
            <footer className="px-4 divide-y text-gray-100">
                ...
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 gap-5">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="items-center justify-center dark:bg-violet-400">

                                <span className="self-center text-2xl font-semibold"><img src={logo} alt="" /></span>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos laborum, tempora ullam, ipsam fugit dolore earum amet veritatis quod in .</p>
                            </div>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase dark:text-gray-50 font-semibold">Product</h3>
                        ...
                        <div className="space-y-3">
                            <h3 className="uppercase dark:text-gray-50 font-semibold">Developers</h3>
                            <ul className="space-y-1">
                                <li>
                        ...
                        <div className="space-y-3">
                            <div className="uppercase dark:text-gray-50 font-semibold">Social media</div>
